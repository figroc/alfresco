            ...
            <div class="node-header">
               ...
               <#else>
                  ...
                  <div>
                     ...
                     <span class="item item-separator item-social" style="display:inline">
                        <a href="#" name="@commentNode" rel="${nodeRef?js_string}" class="theme-color-1 comment ${id}" title="${msg("comment.${itemType}.tip")}" tabindex="0" style="display:inline">${msg("comment.${itemType}.label")}</a><#if commentCount??><span class="comment-count" style="display:inline">${commentCount}</span></#if>
                     </span>
                     </#if>
